...
let seleccionarProducto = parseInt(prompt("1-mantas solar $2000 2-termotanque solar $4000 3-bomba solar $6000 4-panel solar $8000"))
...
while (seleccionarProducto != 0) {
    ...
    seleccionarProducto = parseInt(prompt("1-mantas solar $2000 2-termotanque solar $4000 3-bomba solar $6000 4-panel solar $8000"))
}
